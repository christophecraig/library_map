...
<div class='hmenu'>
	...
	<span".ongletSelect("categ=docs&sub=library_map").">
		<a title='".$msg['admin_menu_docs_library_map']."' href='./admin.php?categ=docs&sub=library_map&action='>"
			.$msg['admin_menu_docs_library_map']."
		</a>
	</span>
</div>
";
