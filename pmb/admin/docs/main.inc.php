...
switch($sub) {
	...
	case 'location':
		...
		break;
	case 'sur_location':
		$admin_layout = str_replace('!!menu_sous_rub!!', $msg['sur_location_title'], $admin_layout);
		print $admin_layout;
		echo window_title($database_window_title.$msg['sur_location_title'].$msg['1003'].$msg['1001']);
	...
	case 'perso':
		...
		break;
	case 'library_map':
		$admin_layout = str_replace('!!menu_sous_rub!!', $msg['admin_menu_docs_library_map'], $admin_layout);
		print $admin_layout;
		echo window_title($database_window_title.$msg['admin_menu_docs_library_map'].$msg['1003'].$msg['1001']);
		include("./admin/docs/library_map.inc.php");
		break;
	default:
		$admin_layout = str_replace('!!menu_sous_rub!!', "", $admin_layout);
		print $admin_layout;
		echo window_title($database_window_title.$msg['admin_menu_exemplaires'].$msg['1003'].$msg['1001']);
